      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-24 lg:py-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              ...
              <p className="text-base text-gray-700 md:text-lg">
                As a premium Digital Marketing Agency, we solved some complex problems of our clients. We accentuated case studies where our digital marketing services helped brands overcome them and achieve growth.
              </p>
            </div>
